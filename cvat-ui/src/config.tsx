...
const CHANGELOG_URL = 'https://github.com/VGTHuang/cvat/blob/develop/CHANGELOG.md';
const LICENSE_URL = 'https://github.com/VGTHuang/cvat/blob/develop/LICENSE';
const DISCORD_URL = 'https://discord.gg/fNR3eXfk6C';
const GITHUB_URL = 'https://github.com/VGTHuang/cvat';
const GITHUB_IMAGE_URL = 'https://github.com/VGTHuang/cvat/raw/develop/site/content/en/images/cvat.jpg';
