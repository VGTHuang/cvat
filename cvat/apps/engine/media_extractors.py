...
class Mpeg4ChunkWriter(IChunkWriter):
    ...
    def _add_video_stream(
        ...
        # libopenh264 has 4K limitations, https://github.com/VGTHuang/cvat/issues/7425
        if h * w > (self.MAX_MBS_PER_FRAME << 8):
            raise ValidationError(
                "The video codec being used does not support such high video resolution, refer https://github.com/VGTHuang/cvat/issues/7425"
            )
