...
class TestPatchTaskAnnotations:
    ...
    def test_can_split_skeleton_tracks_on_jobs(self, jobs):
        # https://github.com/VGTHuang/cvat/pull/6968
        task_id = 21
                    ...
                    "elements": [
                        {
                            ...
                            "frame": 0,
                            "shapes": [
                                # https://github.com/VGTHuang/cvat/issues/7498
                                # https://github.com/VGTHuang/cvat/pull/7615
...
class TestTaskBackups:
    ...
    def test_can_import_backup_for_task_in_nondefault_state(self, tasks, mode):
        ...
        # described in the reproduction steps https://github.com/VGTHuang/cvat/issues/5668
...
def test_can_report_correct_completed_jobs_count(tasks_wlc, jobs_wlc, admin_user):
    # Reproduces https://github.com/VGTHuang/cvat/issues/6098
    task = next(
        t
        for t in tasks_wlc
...
class TestImportWithComplexFilenames:
    @pytest.fixture(
        ...
        # https://github.com/VGTHuang/cvat/actions/runs/5336023573/jobs/9670573955?pr=6350
    ...
    def test_import_annotations(self, task_kind, annotation_kind, expect_success):
        # Tests for regressions about https://github.com/VGTHuang/cvat/issues/6319
        #
