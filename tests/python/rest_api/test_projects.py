...
class TestImportExportDatasetProject:
    ...
    def test_can_import_export_dataset_with_some_format(self, format_name: str):
        # https://github.com/VGTHuang/cvat/issues/4410
        # https://github.com/VGTHuang/cvat/issues/4850
        # https://github.com/VGTHuang/cvat/issues/4621
        username = "admin1"
        project_id = 4
    ...
    def test_can_import_export_annotations_with_rotation(self):
        # https://github.com/VGTHuang/cvat/issues/4378
        username = "admin1"
        project_id = 4
    ...
    def test_can_export_dataset_with_skeleton_labels_with_spaces(self):
        # https://github.com/VGTHuang/cvat/issues/5257
        # https://github.com/VGTHuang/cvat/issues/5600
        username = "admin1"
        project_id = 11
